...
class TmdbMovieTest < Test::Unit::TestCase
  ...
  test 'find should pass default language to Tmdb.api_call if language is not supplied' do
    ...
    Tmdb.expects(:api_call).with('search/movie', {:query => '1', :search_type => Tmdb.default_search_type}, Tmdb.default_language)
  ...
  test 'find should pass through language to Tmdb.api_call when language is supplied' do
    ...
    Tmdb.expects(:api_call).with('search/movie', {:query => '1', :search_type => Tmdb.default_search_type}, 'foo')
